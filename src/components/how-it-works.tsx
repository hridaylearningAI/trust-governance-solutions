...
import { Activity, Group } from '@carbon/icons-react'

function WeekPill({ children }: { children: React.ReactNode }) {
    return (
        <span className="inline-block rounded-full bg-brand-soft px-3 py-1 text-xs font-extrabold text-brand-deeper">
            {children}
        </span>
    )
}
...
export function HowItWorks() {
    return (
        <section id="how-it-works" className="scroll-mt-24 bg-mist py-16 md:py-24">
            <div className="mx-auto max-w-5xl px-6">
                <div className="text-center" data-reveal>
                    <h2 className="text-[clamp(1.6rem,3vw,2.1rem)] font-black tracking-[-0.01em] text-ink">How TGS works</h2>
                    <p className="mt-3 text-lg font-medium text-body">Three weeks from first scan to a buyer-ready report.</p>
                </div>
                <div className="relative mt-12">
                    <div className="relative z-10 grid grid-cols-6 gap-3" data-reveal-grid>
                        <Card data-hover-lift className="relative col-span-full order-3 flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative mx-auto flex h-24 w-56 items-center">
                                    ...
                                    <span className="mx-auto block w-fit text-5xl font-black text-ink" data-counter data-counter-value="99" data-counter-suffix="%">99%</span>
                                </div>
                                <div className="mt-6 space-y-2 text-center">
                                    <h3 className="text-lg font-bold text-ink">Attest</h3>
                                    <p className="text-[15px] font-medium text-body">We issue your buyer-ready report and switch on 24/7 monitoring.</p>
                                    <WeekPill>Week 3 → The report</WeekPill>
                                </div>
                            </CardContent>
                        </Card>
                        <Card data-hover-lift className="relative col-span-full order-1 overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h3 className="text-lg font-bold text-ink">Scan</h3>
                                    <p className="text-[15px] font-medium text-body">Connect your stack. We run automated scans and map to frameworks.</p>
                                    <WeekPill>Week 1 → Gap list</WeekPill>
                                </div>
                            </CardContent>
                        </Card>
                        <Card data-hover-lift className="relative col-span-full order-2 overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h3 className="text-lg font-bold text-ink">Fix</h3>
                                    <p className="text-[15px] font-medium text-body">We prioritize what to fix, why it matters, and who owns it.</p>
                                    <WeekPill>Week 2 → Gaps closed</WeekPill>
                                </div>
                            </CardContent>
                        </Card>
                        <Card data-hover-lift className="relative col-span-full order-4 overflow-hidden lg:col-span-3">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <Activity className="m-auto size-5 text-brand-deep" />
                                    </div>
                                    <div className="space-y-2">
                                        <h3 className="text-lg font-bold text-ink">Always-on monitoring</h3>
                                        <p className="text-[15px] font-medium text-body">After your report ships, we keep scanning around the clock — it stays live for every future buyer.</p>
                                    </div>
                                </div>
                        ...
                        <Card data-hover-lift className="relative col-span-full order-5 overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <Group className="m-auto size-5 text-brand-deep" />
                                    </div>
                                    <div className="space-y-2">
                                        <h3 className="text-lg font-bold text-ink">Every gap has an owner</h3>
                                        <p className="text-[15px] font-medium text-body">Findings arrive prioritized and assigned, so nothing stalls between scan and report.</p>
                                    </div>
                                </div>
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs font-semibold text-body shadow-sm">Encryption at rest</span>
                                            <span className="ring-background grid size-7 shrink-0 place-items-center rounded-full bg-navy text-[10px] font-bold text-white ring-4">AR</span>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <span className="ring-background grid size-8 shrink-0 place-items-center rounded-full bg-brand-deep text-[10px] font-bold text-white ring-4">JK</span>
                                            <span className="block h-fit rounded border px-2 py-1 text-xs font-semibold text-body shadow-sm">SSO enforcement</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs font-semibold text-body shadow-sm">Backup policy</span>
                                            <span className="ring-background grid size-7 shrink-0 place-items-center rounded-full bg-navy-soft text-[10px] font-bold text-white ring-4">MP</span>
                                        </div>
                                    </div>
                                </div>
                            </CardContent>
